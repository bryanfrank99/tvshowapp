...
public class AdBlockWebChromeClient extends BridgeWebChromeClient {
    ...
    private static boolean isAllowedHost(String host) {
        ...
        if (host.equals("tvshowapp.net") || host.endsWith(".tvshowapp.net") || host.equals("tvshowapp-one.vercel.app") || host.endsWith(".vercel.app") || host.equals("localhost") || host.equals("capacitor")) return true;
