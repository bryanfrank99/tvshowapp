...
export default function SideNav({ labels }: { labels: Record<string, string> }) {
  ...
  return (
    <nav aria-label="Principal"
      className={`${isTV ? "flex" : "hidden lg:flex"} fixed left-0 top-0 bottom-0 z-40 w-16 hover:w-52 focus-within:w-52 transition-all bg-[#0b0b10] border-r border-white/10 flex-col items-stretch py-4 gap-1 overflow-hidden group/nav`}>
