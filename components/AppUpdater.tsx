        ...
        {updateState === "countdown" && (
          <div className="w-full mb-6">
            <p className="text-zinc-300 text-sm mb-4">
              Actualizando de la versión <span className="font-semibold text-zinc-100">v{currentVersion}</span> a la versión <span className="font-semibold text-emerald-400">v{versionInfo.latestVersion}</span>.
            </p>
