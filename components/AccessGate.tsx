      ...
      <div className="bg-black/30 p-2.5 rounded-xl border border-white/5 mb-3 select-none">
        ...
        <div className="flex justify-center gap-2 mt-2 pt-2 border-t border-white/5">
          <button
            ...
            onClick={handleClear}
            disabled={!code}
            className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-xs font-bold text-zinc-300 disabled:opacity-30 focus:outline-none focus:ring-2 focus:ring-[#008CFF]"
          >
            {d.gate_clear}
          </button>
          <button
