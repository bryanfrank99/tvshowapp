...
export function MediaCard({
  ...
  return (
    <Link
      href={targetHref}
      className={`group relative block bg-zinc-900/60 border border-white/10 rounded-2xl overflow-hidden hover:border-[#008CFF]/80 focus:border-[#008CFF] focus:ring-4 focus:ring-[#008CFF]/50 active:scale-[0.97] transition-[transform,border-color,box-shadow] duration-200 ease-out shadow-sm hover:shadow-[0_8px_20px_rgba(0,0,0,0.35)] touch-manipulation select-none outline-none ${className}`.trim()}
    >
      ...
      <div className="relative aspect-[2/3] w-full overflow-hidden bg-zinc-900">
        ...
        {/* Botón flotante de reproducción en hover y focus */}
        <span className="absolute inset-0 m-auto w-12 h-12 rounded-full opacity-0 group-hover:opacity-100 group-focus:opacity-100 group-[.tv-focused]:opacity-100 scale-90 group-hover:scale-100 group-focus:scale-100 group-[.tv-focused]:scale-100 transition-all duration-200 flex items-center justify-center bg-gradient-to-br from-[#008CFF] to-[#008CFF]/80 shadow-[0_0_24px_rgba(0,140,255,0.7)] ring-1 ring-white/40 pointer-events-none">
      ...
      <div className="p-2.5 sm:p-3">
        <p className="text-xs sm:text-sm font-semibold truncate text-zinc-100 group-hover:text-[#008CFF] group-focus:text-[#008CFF] group-[.tv-focused]:text-[#008CFF] transition-colors" title={title}>
          {title}
        </p>
...
export function Top10Card({ item }: { item: Media }) {
  ...
  return (
    <Link
      ...
      className="group relative flex gap-3.5 items-center bg-zinc-900/60 border border-white/10 rounded-2xl p-3 hover:border-[#008CFF]/80 focus:border-[#008CFF] focus:ring-4 focus:ring-[#008CFF]/50 active:scale-[0.98] transition-[transform,border-color,box-shadow] duration-200 ease-out touch-manipulation w-full max-w-full min-w-0 outline-none"
    >
      <span
      ...
      <div className="relative shrink-0 overflow-hidden rounded-xl bg-zinc-900">
        <Image
          ...
          width={64}
          height={96}
          className="w-16 aspect-[2/3] object-cover group-hover:scale-105 group-focus:scale-105 group-[.tv-focused]:scale-105 transition-transform duration-300"
          loading="lazy"
        />
      </div>
      <div className="min-w-0 flex-1">
        <p className="text-sm font-bold truncate group-hover:text-[#008CFF] group-focus:text-[#008CFF] group-[.tv-focused]:text-[#008CFF] transition-colors" title={title}>
          {title}
        </p>
